...
<div class="d-grid gap-2 d-md-flex justify-content-between align-items-center">
    <h1><b>Registro Departamentos de Empresa</b></h1>
  <button class="btn btn-dark btn-lg" data-bs-toggle="modal" data-bs-target="#addDeptoEmpresa" type="button"><b>Agregar Departamento</b></button>
</div>
  @stop
  ...
  @section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
                    ...
                    <input type="text" class="form-control alphanumeric-input" name="NOM_DEPTO_EMPRESA" required minlength="4" maxlength="50">                   
                    </div>
                     
                    <div class="mb-3 mt-3">
                    <label for="dni" class="form-label">Descripción</label>
                    <input type="text" class="form-control alphanumeric-input"  name="DES_DEPTO_EMPRESA" required minlength="4" maxlength="50">                   
                    </div>
