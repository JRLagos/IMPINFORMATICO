...
@section('content_header')
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-between align-items-center">
        ...
        <button
            ...
            data-bs-toggle="modal" data-bs-target="#addPersona" type="button"><b>Agregar
                Empleado</b></button>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('Post-Persona.store') }}" method="post" class="was-validated">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="date" class="form-control" max="<?= date('Y-m-d') ?>" name="FEC_NAC_PERSONA"
                                required>
                        </div>
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" name="DES_DIRECCION" id="direccionInput" required
                                minlength="3" maxlength="50">
