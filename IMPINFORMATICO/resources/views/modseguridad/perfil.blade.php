...
.user-card-full .social-link li a {
    ...
    button {
        padding: 8px 13px;
        background-color: #ee5a6f; /* Color de fondo */
        color: white; /* Color del texto */
        border: none;
        border-radius: 5px;
        cursor: pointer;
        margin-top: 15px; /* Márgen superior */
    }
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                <div class="m-b-25">
                                                                <img width="75" height="75s" src="https://img.icons8.com/glyph-neue/64/group--v1.png" alt="group--v1"/>
                                                                </div>
                                                                <h6 class="f-w-600" >{{ $usuario['NOM_USUARIO'] }}</h6>
                                                                <p>{{ $usuario['NOM_ROL'] }}</p>
