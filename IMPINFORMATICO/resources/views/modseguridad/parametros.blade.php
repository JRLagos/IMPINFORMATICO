    ...
    <tr>
        ...
        <tr>
                   ...
                   <td style="text-align: center;">{{ date('d-m-Y', strtotime($Parametros['FEC_MODIFICACION'])) }}</td>
                    ...
                    @endphp
                        <button value="Editar" title="Editar" class="btn @if (!$permisoEditar) btn-secondary disabled @else btn-warning @endif " type="button" data-toggle="modal" data-target="#Parametro-edit-{{$Parametros['COD_PARAMETRO']}}">
