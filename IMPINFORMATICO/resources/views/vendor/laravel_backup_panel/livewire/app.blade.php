<div class="container mb-5">
    <div class="d-flex align-items-end pt-4">
        <button class="btn btn-primary" onclick="goBack()">Atrás</button>
        <div>
            <h5 class="mb-0" style="text-align: center; font-weight: bold;">
        ...
        <!--  <form method="post" action="
            @csrf
            <button type="submit" class="btn btn-primary">Realizar copia de seguridad de la base de datos</button>
        </form>
        

         <input type="button" id="btnbackup" value="Crear copia de seguridad">
                            ...
                            <div class="modal-body">
                                ...
                                @if ($deletingFile)
                                    <span class="text-muted">
                                        ¿Estas seguro que deseas eliminar el backup creado el
                                        {{ $deletingFile['date'] }} ?
                                    </span>
                                @endif
                            </div>
    ...
    <script>
        /*$("#btnbackup").on("click",function(){
                        document.write('<?php $respuesta = exec('php artisan backup:run'); ?>');
                        location.reload();
                        });*/
        ...
        /*  document.getElementById("btnbackup").addEventListener("click", function(e) {
              ...
              objXMLHttpRequest.open('GET', 'ajaxglobal.php?caso=pruebabackup');
        ...
        /* $('#btnbackup').click(function() {
             ...
             button.text('Creando copia de seguridad...');
             alert("hola desde laravel 2");
             /*$.ajax({
                 url: '/run-backup',
                 method: 'GET',
                 success: function(data) {
                     button.prop('disabled', false);
                     button.text('Ejecutar copia de seguridad');
